...
fig3 = figure('OuterPosition',[scrsz(3)*2/3 0 scrsz(3)/3 scrsz(4)/2]);
hold on; grid off; ylabel('Yaw rate [deg/s]'); xlabel('Time [s]');
...
axis([0 tstop 0 0.55]);
legend( 'Ship, \delta = 5' ,'Non-lin Nomoto2, \delta = 5', ...
        'Ship, \delta = 15','Non-lin Nomoto2, \delta = 15',...
        'Ship, \delta = 25','Non-lin Nomoto2, \delta = 25'); 
saveas(fig3,'Task1_4_Nomoto2_nonlin.eps','epsc');
